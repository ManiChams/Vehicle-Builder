  ...
  performActions(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        // DONE! TODO: add statements to perform the tow action only if the selected vehicle is a truck. Call the findVehicleToTow method to find a vehicle to tow and pass the selected truck as an argument. 
        // After calling the findVehicleToTow method, you will need to return to avoid instantly calling the performActions method again since findVehicleToTow is asynchronous.
          ...
          if (truck) {
            ...
            console.log(`This command is only avaliable for Trucks!`);
          }
        }
        ...
        // DONE! TODO: add statements to perform the wheelie action only if the selected vehicle is a motorbike
          ...
          if (motorbike) {
            ...
            console.log(`This command is only avaliable for Motorbikes!`);
          }
        }
